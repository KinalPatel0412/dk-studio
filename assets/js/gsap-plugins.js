...
!(function(t, e) {
                ...
                if ((this !== L && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            (this._time = i),
                            (this._act = !l),
                            this._initted || ((this._onUpdate = this.vars.onUpdate), (this._initted = 1), (this._zTime = t), (_ = 0)), !_ && i && !e && (Ct(this, "onStart"), this._tTime !== v))
                    )
                        return this;
                    if (_ <= i && 0 <= t)
                        for (n = this._first; n;) {
                    ...
                    (d || e in t || Q(e, n),
                        function _addComplexStringPropTween(t, e, r, i, n, a, s) {
                            var o,
                                ...
                                m = 0,
                                g = 0;
                            for (_.b = r, _.e = i, r += "", (d = ~(i += "").indexOf("random(")) && (i = ob(i)), a && (a((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(it) || [];
                                (o = it.exec(i));)
                                (l = o[0]),
            ...
            if (((a._targets = C.length ? ea(C) : R("GSAP target " + e + " not found. https://greensock.com", !j.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = b), x || T || y(_) || y(m))) {
                if (((r = a.vars), (s = a.timeline = new Ut({
                    ...
                    for (o = 0; o < h; o++)
                        ...
                        (u.delay = (+Qt(m, _assertThisInitialized(a), o, f, C) || 0) - a._delay), !T && 1 === h && u.delay && ((a._delay = m = u.delay), (a._start += m), (u.delay = 0)),
    ...
    function Qd() {
        ...
        window.document &&
            ((Ae = window), (Se = Ae.document), (Re = Se.documentElement), (Ee = Md("div") || {
                style: {}
                    ...
                    if (
                        (lt(Te),
                            ...
                            (!1 === ae || ae === Ct || (ae = !(!ae && ie.parentNode && ie.parentNode.style && "flex" === eb(ie.parentNode).display) && St),
                                ...
                                (R = n.pinState) :
                                (l && ((l = J(l)) && !l.nodeType && (l = l.current || l.nativeElement), (n.spacerIsNative = !!l), l && (n.spacerState = _b(l))), (n.spacer = N = l || je.createElement("div")), N.classList.add("pin-spacer"), a && N.classList.add("pin-spacer-" + a), (n.pinState = R = _b(ie))), !1 !== S.force3D && He.set(ie, {
                                    force3D: !0
                                }),
        ...
        r = {
            ...
            render: function render(e, t) {
                ...
                t.x < 0 && (t.x = 0),
                    ...
                    d ? T.scrollTo(t.skipX ? o : t.x, t.skipY ? n : t.y) : (t.skipY || (c.scrollTop = t.y), t.skipX || (c.scrollLeft = t.x)), !g || (1 !== e && 0 !== e) || ((n = c.scrollTop), (o = c.scrollLeft), x ? (c.style.scrollSnapType = x) : c.style.removeProperty("scroll-snap-type"), (c.scrollTop = n + 1), (c.scrollLeft = o + 1), (c.scrollTop = n), (c.scrollLeft = o)),
                    (t.xPrev = t.x),
                    (t.yPrev = t.y),
                    h && h.update();
            },
